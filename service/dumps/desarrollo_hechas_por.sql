...
--
-- Table structure for table `hechas_por`
--

DROP TABLE IF EXISTS `hechas_por`;
...
CREATE TABLE `hechas_por` (
  ...
  CONSTRAINT `hechas_por_ibfk_1` FOREIGN KEY (`DNI`) REFERENCES `artistas` (`DNI`),
  CONSTRAINT `hechas_por_ibfk_2` FOREIGN KEY (`nombre_escultura`) REFERENCES `esculturas` (`nombre`)
