...
--
-- Table structure for table `compiten`
--

DROP TABLE IF EXISTS `compiten`;
...
CREATE TABLE `compiten` (
  ...
  CONSTRAINT `compiten_ibfk_1` FOREIGN KEY (`nombre_evento`) REFERENCES `eventos` (`nombre`),
  CONSTRAINT `compiten_ibfk_2` FOREIGN KEY (`nombre_escultura`) REFERENCES `esculturas` (`nombre`)
